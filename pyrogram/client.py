    ...
    async def get_file(
        ...
        async with self.get_file_semaphore:
            ...
            try:
                ...
                if _is_bot:
                    dl_pool_size = int(os.environ.get("WZGRAM_DL_POOL_BOT", 4))
                    dl_workers_per_session = int(os.environ.get("WZGRAM_DL_WORKERS_BOT", 3))
                    dl_rate = int(os.environ.get("WZGRAM_DL_RATE_BOT", 60))
                    dl_burst = int(os.environ.get("WZGRAM_DL_BURST_BOT", 15))
                elif _is_premium:
                    ...
                    dl_rate = int(os.environ.get("WZGRAM_DL_RATE_PREMIUM", 100))
                    dl_burst = int(os.environ.get("WZGRAM_DL_BURST_PREMIUM", 25))
                else:
                    dl_pool_size = int(os.environ.get("WZGRAM_DL_POOL_USER", 4))
                    dl_workers_per_session = int(os.environ.get("WZGRAM_DL_WORKERS_USER", 3))
                    dl_rate = int(os.environ.get("WZGRAM_DL_RATE_USER", 60))
                    dl_burst = int(os.environ.get("WZGRAM_DL_BURST_USER", 15))
