...
class Session:
    ...
    MAX_SKEW_BEHIND = 300
    MAX_SKEW_BREACHES = 3
    MAX_INFLIGHT_PACKETS = int(os.environ.get("WZGRAM_MAX_INFLIGHT_PACKETS", 12))
    MAX_INFLIGHT_MEDIA = int(os.environ.get("WZGRAM_MAX_INFLIGHT_MEDIA", 4))
    INLINE_CRYPTO_MAX = int(os.environ.get("WZGRAM_INLINE_CRYPTO_MAX", 1024 * 1024))
